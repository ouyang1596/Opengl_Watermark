package com.example.siyisong.opengl_watermark.watermark.mediacodec;
...
import com.example.siyisong.opengl_watermark.MyApplication;
import com.example.siyisong.opengl_watermark.R;
import com.example.siyisong.opengl_watermark.watermark.bean.VideoInfo;
import com.example.siyisong.opengl_watermark.watermark.filter.AFilter;
import com.example.siyisong.opengl_watermark.watermark.filter.GPUImageFilter;
import com.example.siyisong.opengl_watermark.watermark.filter.GroupFilter;
import com.example.siyisong.opengl_watermark.watermark.filter.NoFilter;
import com.example.siyisong.opengl_watermark.watermark.filter.RotationOESFilter;
import com.example.siyisong.opengl_watermark.watermark.filter.WaterMarkFilter;
import com.example.siyisong.opengl_watermark.watermark.utils.EasyGlUtils;
import com.example.siyisong.opengl_watermark.watermark.utils.MatrixUtils;
...
//        mShow.setMatrix(MatrixUtils.flip(MatrixUtils.getOriginalMatrix(), false, true));
        ...
        waterMarkFilter.setPosition(0, 170, 0, 0);
...
//        if (mGpuFilter != null) {
//            Log.i("Ryan", "fTexture[1]" + fTexture[1]);
...
//        }
        ...
        if (videoChanged) {
            Log.i("Ryan", "x==" + x + " y==" + y + " width==" + width + " height==" + height);
            GLES20.glViewport(x, y, width, height);
        }

//        mShow.setTextureId(fTexture[mGpuFilter == null ? 0 : 1]);
//        Log.i("Ryan", "fTexture[0]==" + fTexture[0] + " mBeFilter.getOutputTexture()==" + mBeFilter.getOutputTexture());
