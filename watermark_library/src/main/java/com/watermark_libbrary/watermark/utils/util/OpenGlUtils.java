package com.watermark_libbrary.watermark.utils.util;
...
import com.watermark_libbrary.watermark.utils.Rotation;
import com.watermark_libbrary.watermark.utils.TextureRotationUtil;
...
public class OpenGlUtils {
    ...
    public static String readShaderFromRawResource(final int resourceId) {
        final InputStream inputStream = Constants.application.getResources().openRawResource(
                resourceId);
