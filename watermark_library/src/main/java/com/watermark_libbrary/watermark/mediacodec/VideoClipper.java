...
import com.watermark_libbrary.watermark.helper.MagicFilterFactory;
...
public class VideoClipper {
    ...
    private VideoInfo.Watermark watermark;

    public VideoInfo.Watermark getWatermark() {
        return watermark;
    }

    public void setWatermark(VideoInfo.Watermark watermark) {
...
//                muxAudioTrack = mMediaMuxer.addTrack(format);
    ...
    private void initVideoInfo() {
        ...
        Log.i("Ryan", "videoWidth==" + videoWidth + " videoHeight==" + videoHeight + " videoRotation==" + videoRotation);
    }
...
//        outputSurface.isBeauty(isOpenBeauty);
    ...
    private synchronized void release() {
        Log.i("Ryan", "release==videoFinish==" + videoFinish + " audioFinish==" + audioFinish + " released==" + released);
